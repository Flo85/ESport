...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Enum Capacity</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see eSport.ESportPackage#getEnumCapacity()
 * @model
 * @generated
 */
public enum EnumCapacity implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Enum Capacity</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final EnumCapacity[] VALUES_ARRAY =
		new EnumCapacity[] {
			POSITIONING,
			STRESS_MANAGEMENT,
	...
	/**
	 * A public read-only list of all the '<em><b>Enum Capacity</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<EnumCapacity> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Enum Capacity</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static EnumCapacity get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EnumCapacity result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Enum Capacity</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static EnumCapacity getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EnumCapacity result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Enum Capacity</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static EnumCapacity get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private EnumCapacity(int value, String name, String literal) {
		this.value = value;
		this.name = name;
