 ...
 * </p>
 * <ul>
 *   <li>{@link eSport.impl.CapacityImpl#getType <em>Type</em>}</li>
 *   <li>{@link eSport.impl.CapacityImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapacityImpl extends MinimalEObjectImpl.Container implements Capacity {
	...
	protected EClass eStaticClass() {
		return ESportPackage.Literals.CAPACITY;
	}
	...
	public void setValue(int newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESportPackage.CAPACITY__VALUE, oldValue, value));
	}
